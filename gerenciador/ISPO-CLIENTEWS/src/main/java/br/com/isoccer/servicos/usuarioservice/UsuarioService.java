...
public interface UsuarioService {
     ...
     * @return
     *     returns br.com.isoccer.servicos.usuarioservice.OutValidarUsuario
     * @throws IspoException_Exception
     */
    @WebMethod
    @WebResult(name = "usuarioValido", targetNamespace = "http://isoccer.com.br/servicos/UsuarioService", partName = "usuarioValido")
    public OutValidarUsuario validarUsuario(
        @WebParam(name = "inValidarUsuario", targetNamespace = "http://isoccer.com.br/servicos/UsuarioService", partName = "inValidarUsuario")
